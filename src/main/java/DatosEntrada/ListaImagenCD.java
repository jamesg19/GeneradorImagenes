...
public class ListaImagenCD {
    nodoImagenCD primero;
    nodoImagenCD ultimo;
    int IdUser;
    String FORMATO_LISTA_IMG="";

    public ListaImagenCD() {
        primero=null;
        ultimo=null;
    }
    public void insertarNodo(int newId){
        nodoImagenCD nuevo= new nodoImagenCD();
        nuevo.id=newId;
        if(primero ==null){
            primero=nuevo;
    ...
    public void buscarNodo(int idBuscado){
        nodoImagenCD actual= new nodoImagenCD();
        actual=ultimo;
        do{
    ...
    public void eliminarNodo(int id_eliminar){
        nodoImagenCD actual= new nodoImagenCD();
        nodoImagenCD anterior= new nodoImagenCD();
        actual=primero;
        anterior= ultimo;
        do{
